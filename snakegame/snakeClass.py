...
class Game:
    ...
    def __init__(self, game_width, game_height):
        ...
        self.bg = pygame.image.load("snakegame/img/background.png")
        self.crash = False
...
class Player(object):
    ...
    def __init__(self, game):
        ...
        self.food = 1
        self.eaten = False
        self.image = pygame.image.load('snakegame/img/snakeBody.png')
        self.x_change = 20
        self.y_change = 0
...
class Food(object):
    ...
    def __init__(self):
        self.x_food = 240
        self.y_food = 200
        self.image = pygame.image.load('snakegame/img/food2.png')
