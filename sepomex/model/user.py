...
class User(models.Model):
    UserId = models.AutoField(db_column='UsuarioID', primary_key=True)  # Field name made lowercase.
    ...
    Name = models.CharField(db_column='Nombre', max_length=50)  # Field name made lowercase.
    activo = models.BooleanField(db_column='Activo')  # Field name made lowercase.
    ...
    def __str__(self):
        return "{} - {}".format(self.UsuarioId, self.Name)
    class Meta:
        managed = False
        db_table = 'Usuario'
